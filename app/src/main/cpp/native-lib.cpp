...
Java_com_androidz_libjpeg_1turbo_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_androidz_libjpeg_1turbo_MainActivity_nativeCompressBitmap(JNIEnv *env, jobject thiz,
    ...
    BYTE *data;
    BYTE *tmpData;
    const char *dstFileName = jstringToString(env, dest_file);
    //解码Android Bitmap信息
    ...
    //进行压缩
    ret = generateJPEG(tmpData, w, h, quality, dstFileName, quality);
